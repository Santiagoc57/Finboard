...
ASSETS_INDICES_ETFS = {
    ...
    "Nikkei 225": {"src": "yahoo", "id": "^N225"},
    "Bovespa": {"src": "yahoo", "id": "^BVSP"},
    "KOSPI": {"src": "yahoo", "id": "^KS11"},
    "IPC (MXX)": {"src": "yahoo", "id": "^MXX"},
    "CLX IPSA": {"src": "yahoo", "id": "^IPSA"},
    "FTSE 100": {"src": "yahoo", "id": "^FTSE"},
